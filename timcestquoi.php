   ...
   <!-- #TIM? image -->
      <section>
        ...
        <article id="descriptionproweb">
                ...
                <li><p>Le programme de DEC en Techniques d'intégration multimédia du Cégep de Matane vise à former des techniciens et techniciennes exerçant les fonctions de travail à titre de développeur, concepteur, designer et réalisateur multimédia. Ces personnes interviennent tout le long du processus de production d'un projet multimédia, soit de l'étape de l'analyse du projet à celle de contrôle de la qualité et ce, jusqu'à la livraison d'un produit multimédia.</p></li>
                
                <h2 id="lienancre"><a href="#matieresmulti">Les matières de Multi </a></h2>
    ...
    <div id="content">
      ...
      <div id="conteneurmatieres">
        ...
        <div id="matieres">
          ...
          <div class="mat">
            ...
            <p>
              L'étudiant aborde la manipulation des images et des textes sous l'angle des traitements matriciels. Il se familiarise avec les différents périphériques d'entrée. Il crée et optimise les éléments visuels d'une page-écran en vue de leur intégration au sein d'une production multimédia. Il prend conscience des enjeux reliés à la propriété intellectuelle.
            </p>
            <p class="imgillu">
              <img src="lapin" alt="la petite image qui illustre" title="image qui illustre" width="370" height="100px;" />
            </p>
      ...
      <div id="conteneurmatieres">
        ...
        <div class="conteneursecondaire">
            <p class="imgalign">
              <img src="images/comparaison.jpg" alt="tableau comparatif" title="tableau comparatif" width="90%" height="90%" />
            </p>
        </div><!-- FIN VS -->
      </div><!-- FIN CONTENEURVS -->
