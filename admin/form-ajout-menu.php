...
<body>
	...
	<form action="traitement-ajouter-menu.php" method="POST">
		...
		<fieldset>
			...
			<div>
				<label for="nom_lien">Lien de la page vers lequel le menu va pointé si on clic dessus. Laissez ce champs vide si ce menu contients  des sous menus.</label>
				<input type="text" name="nom_lien" />
			</div>
