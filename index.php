    ...
    <aside id="right_column">
      ...
      <nav>
        <ul>
          ...
          <li><a href="#" title="Visitez le portefolio de l'étudiant : Pierre Laroche" class="tooltip"> <img src="images/portefolio_etudiant.jpg"> </a></li>
          <li><a href="#" title="Visitez le portefolio de l'étudiant : Pierre Laroche" class="tooltip"> <img src="images/etudiants.jpg"> </a></li>
          <li><a href="#" title="Visitez le portefolio de l'étudiant : Pierre Laroche"class="tooltip"> <img src="images/portefolio1.jpg"> </a></li>
        </ul>
